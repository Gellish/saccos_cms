...
<html lang="en">
    ...
    <div class="block white">
        <div class="container">
            <div class="row">
                <div class="span6">
                    <h3>Welcome to VIKOBA PLUS</h3>
                    <hr/>
                    <ul>
                        <li>VIKOBA Plus is an end-to-end information system which enables the management of Saving and Credit cooperatives in a manner that provides seamless information flow of all  the activities and transactions.</li><br/>
                        <li>VIKOBA Plus come with a wide range of financial reports which aid accurate planning, forecast and decision making</li><br/>
                        <li>Offering the service to a broad range of clientele in Eastern Africa. At the moment it can be used in two languages : English and Swahili</li>
                    </ul>
                </div>
            ...
            <div style="border-top : 2px solid #e7eaec; text-align: center; margin-top: 20px; padding-top: 10px;">
                <div id="copyright">© 2017&nbsp; &nbsp; VIKOBA PLUS . All right reserved</div>
                <div>
                    <span> Designed and Developed by :</span>
                    <a href="http://helmatechnologies.com/" target="_blank"> HELMA TECHNOLOGIES CO LTD</a>
                </div>
            </div>
        </div>
    </div>
